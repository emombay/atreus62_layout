 ...
 * `--------------------------------------------------'   '--------------------------------------------------'
  */
  [_RAISE] = {
   ...
   { _______  ,_______  ,_______  ,_______  ,_______  ,_______  ,_______ ,_______  ,_______, KC_PSLS, KC_PAST, KC_PMNS,  TO(_GAME) },
 ...
 * `--------------------------------------------------'   '--------------------------------------------------'
  */
  [_GAME] = {
   ...
   { _______  ,_______,  _______,  _______,  _______,  _______,        _______ ,_______,  _______,  _______,  _______,  _______,  TO(_WRKMN) },
   { _______  ,_______,  _______,  _______,  _______,  _______,        _______ ,_______,  _______,  _______,  _______,  _______,  _______ },
   { _______  ,_______,  _______,  _______,  _______,  _______,        _______ ,_______,  _______,  _______,  _______,  _______,  _______ },
   { _______  ,_______,  _______,  _______,  _______,  _______,        _______, _______,  _______,  _______,  _______,  _______,  _______ },
   { _______  ,_______,  _______,  _______,  _______,  CTL_T(KC_SPC),  _______ ,_______,  _______,  _______,  _______,  _______,  _______ }
